...
| [i-am-bee/beeai-framework](https://github.com/i-am-bee/beeai-framework) (IBM-originated, now Linux Foundation AI & Data) | Fixed `ConditionalRequirement`'s target validation being a permanent no-op — an intersection where union was intended made every typo'd tool name in `RequirementAgent`'s flagship construct silently pass instead of raising — [#1649](https://github.com/i-am-bee/beeai-framework/pull/1649) |
